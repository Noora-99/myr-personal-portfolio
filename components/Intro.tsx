...
import { FaWeixin, FaTelegramPlane } from 'react-icons/fa'
  ...
  return (
    <section
        ...
        <motion.div
          ...
          <div className="text-center">
            ...
            <h2
              ...
              <TypeAnimation
                sequence={['Product Manager', 1000, 'Solutions Engineer', 1000]}
                wrapper="span"
                speed={50}
                repeat={Infinity}
              />
      ...
      <motion.div
        ...
        <div className="absolute left-8 top-10 hidden sm:block">
          <Image
        ...
        <Link
          ...
          href={activeLocale == 'en' ? '/yiru-solutionsEngineer.pdf' : '/解决方案工程师-马一如.pdf'}
          locale={false}>
          {t('download_cv')}
          <HiDownload />
        </Link>
        ...
        {/* <a
          className=" bg-white py-2 px-3 text-sm text-gray-700 flex items-center gap-2  rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://noora-99.github.io/ichi.github.io/"
          target="_blank">
          {t('blog')}
        </a> */}
        <div
